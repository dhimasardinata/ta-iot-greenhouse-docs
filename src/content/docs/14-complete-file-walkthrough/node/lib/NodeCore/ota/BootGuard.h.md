---
title: "node/lib/NodeCore/ota/BootGuard.h"
---

# node/lib/NodeCore/ota/BootGuard.h
...
| Item | Nilai |
|---|---|
| Source file | `node/lib/NodeCore/ota/BootGuard.h` |
...
|---|---|
| Include | `Arduino.h` |
| Class/Struct | `BootGuard`, `RebootReason`, `alignas` |
| Enum | `RebootReason`, `as` |
| Fungsi C/C++ | `markStable`, `incrementCrashCount`, `clear`, `getCrashCount`, `setRebootReason`, `getLastRebootReason`, `read`, `write`, `calculateCRC`, `isValidReason` |
| Macro | `BOOT_GUARD_H` |
| String command/konfigurasi | `reboot` |
