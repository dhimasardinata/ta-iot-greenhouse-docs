---
title: "node/lib/NodeCore/ota/OtaManager.Context.h"
---

# node/lib/NodeCore/ota/OtaManager.Context.h
...
| Item | Nilai |
|---|---|
| Source file | `node/lib/NodeCore/ota/OtaManager.Context.h` |
...
|---|---|
| Include | `memory`, `WiFiClientSecureBearSSL.h`, `config/constants.h` |
| Class/Struct | `ResourceState`, `GuardPolicy`, `RuntimeHealth` |
| Macro | `OTA_MANAGER_CONTEXT_H` |
