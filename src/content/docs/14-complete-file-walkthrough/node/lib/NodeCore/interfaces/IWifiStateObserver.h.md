---
title: "node/lib/NodeCore/interfaces/IWifiStateObserver.h"
---

# node/lib/NodeCore/interfaces/IWifiStateObserver.h

File ini mendefinisikan kontrak IWifiStateObserver. Kontrak seperti ini dipakai agar modul lain bisa bergantung pada kemampuan yang jelas tanpa harus tahu detail class konkret yang menjalankannya.

## Metadata File

| Item | Nilai |
|---|---|
| Source file | `node/lib/NodeCore/interfaces/IWifiStateObserver.h` |
...
| Class/Struct | `IWifiStateObserver` |
| Macro | `I_WIFI_STATE_OBSERVER_H` |
...
#include "net/WifiManager.h"  // Needed for the State enum
/**
