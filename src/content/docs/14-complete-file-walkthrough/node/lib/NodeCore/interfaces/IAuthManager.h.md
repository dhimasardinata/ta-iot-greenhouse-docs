---
title: "node/lib/NodeCore/interfaces/IAuthManager.h"
---

# node/lib/NodeCore/interfaces/IAuthManager.h

File ini mendefinisikan kontrak IAuthManager. Kontrak seperti ini dipakai agar modul lain bisa bergantung pada kemampuan yang jelas tanpa harus tahu detail class konkret yang menjalankannya.

## Metadata File

| Item | Nilai |
|---|---|
| Source file | `node/lib/NodeCore/interfaces/IAuthManager.h` |
...
|---|---|
| Include | `cstdint` |
| Class/Struct | `IAuthManager` |
| Fungsi C/C++ | `isClientAuthenticated`, `setClientAuthenticated`, `isClientLockedOut`, `recordFailedLogin`, `clearFailedLogins` |
| Fungsi JavaScript | `overhead`, `calls` |
| Macro | `IAUTH_MANAGER_H` |
