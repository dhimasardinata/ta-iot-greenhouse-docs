---
title: "node/lib/NodeCore/system/NodeIdentity.h"
---

# node/lib/NodeCore/system/NodeIdentity.h

File ini menyatukan identitas node yang dipakai saat perangkat mengirim data ke sistem.

## Metadata File

| Item | Nilai |
|---|---|
| Source file | `node/lib/NodeCore/system/NodeIdentity.h` |
...
| Fungsi C/C++ | `buildUserAgent`, `buildDeviceId` |
| Macro | `NODE_IDENTITY_H` |
