---
title: "node/lib/NodeCore/support/RuntimeClock.h"
---

# node/lib/NodeCore/support/RuntimeClock.h

File ini menyediakan sumber waktu runtime untuk interval, timeout, dan jadwal kerja firmware.

## Metadata File

| Item | Nilai |
|---|---|
| Source file | `node/lib/NodeCore/support/RuntimeClock.h` |
