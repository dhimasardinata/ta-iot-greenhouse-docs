---
title: "node/lib/NodeCore/support/ParseUtils.h"
---

# node/lib/NodeCore/support/ParseUtils.h

File ini berisi helper parsing agar input string, angka, dan command tidak diolah secara berulang di banyak tempat.

## Metadata File

| Item | Nilai |
|---|---|
| Source file | `node/lib/NodeCore/support/ParseUtils.h` |
