---
title: "node/lib/NodeCore/support/PrecisionTypes.h"
---

# node/lib/NodeCore/support/PrecisionTypes.h

File ini menyatukan tipe presisi angka agar nilai sensor dan perhitungan terkait tidak memakai tipe yang berbeda-beda tanpa alasan.

## Metadata File

| Item | Nilai |
|---|---|
| Source file | `node/lib/NodeCore/support/PrecisionTypes.h` |
