---
title: "node/lib/NodeCore/security/TrustAnchors.cpp"
---

# node/lib/NodeCore/security/TrustAnchors.cpp

File ini mengatur trust anchor atau akar kepercayaan TLS yang dipakai saat node memverifikasi koneksi HTTPS.

## Metadata File

| Item | Nilai |
|---|---|
| Source file | `node/lib/NodeCore/security/TrustAnchors.cpp` |
