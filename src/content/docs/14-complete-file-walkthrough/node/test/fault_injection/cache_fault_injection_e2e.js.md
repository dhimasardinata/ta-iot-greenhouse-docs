---
title: "node/test/fault_injection/cache_fault_injection_e2e.js"
---
...
| Item | Nilai |
|---|---|
| Source file | `node/test/fault_injection/cache_fault_injection_e2e.js` |
...
|---|---|
| Fungsi C/C++ | `fail`, `Error`, `assert`, `loadCacheCrcTrace`, `run` |
| Fungsi JavaScript | `fail`, `assert`, `loadCacheCrcTrace`, `run` |
| String command/konfigurasi | `path`, `utf8`, `firmware`, `rtc_fail_to_fs`, `both_fail` |
