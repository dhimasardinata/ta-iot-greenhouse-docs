---
title: "node/test/test_native_stress/test_system_stress.cpp"
---

# node/test/test_native_stress/test_system_stress.cpp
...
| Item | Nilai |
|---|---|
| Source file | `node/test/test_native_stress/test_system_stress.cpp` |
...
|---|---|
| Include | `unity.h`, `NativeTestHelper.h`, `MockSystem.h` |
| Fungsi C/C++ | `logic_sendNetworksJson`, `test_apiclient_payload_fragmentation`, `test_simulated_system_load` |
| Fungsi JavaScript | `COMPILATION` |
| Macro | `NATIVE_TEST` |
| String command/konfigurasi | `build_src_filter`, `native`, `test_token_123` |
