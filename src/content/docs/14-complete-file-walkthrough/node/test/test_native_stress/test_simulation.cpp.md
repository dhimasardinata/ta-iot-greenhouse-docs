---
title: "node/test/test_native_stress/test_simulation.cpp"
---
...
| Item | Nilai |
|---|---|
| Source file | `node/test/test_native_stress/test_simulation.cpp` |
...
|---|---|
| Include | `unity.h`, `iostream`, `random`, `vector`, `NativeTestHelper.h`, `support/Crc32.cpp`, `storage/CacheManager.cpp` |
| Fungsi C/C++ | `generate_valid_payload`, `test_peak_load_simulation`, `rng`, `op_dist` |
| Macro | `NATIVE_TEST` |
| String command/konfigurasi | `head`, `tail` |
