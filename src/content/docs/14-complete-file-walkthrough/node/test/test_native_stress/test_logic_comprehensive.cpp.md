---
title: "node/test/test_native_stress/test_logic_comprehensive.cpp"
---

# node/test/test_native_stress/test_logic_comprehensive.cpp
...
| Item | Nilai |
|---|---|
| Source file | `node/test/test_native_stress/test_logic_comprehensive.cpp` |
...
|---|---|
| Include | `unity.h`, `iostream`, `vector`, `string.h`, `NativeTestHelper.h`, `system/ConfigManager.h`, `net/WifiCredentialStore.h` |
| Fungsi C/C++ | `test_config_validation`, `test_wifi_store`, `test_json_escaping` |
| Macro | `NATIVE_TEST` |
| String command/konfigurasi | `secret123`, `llo` |
