---
title: "node/test/mocks/LittleFS.h"
---

# node/test/mocks/LittleFS.h
...
| Item | Nilai |
|---|---|
| Source file | `node/test/mocks/LittleFS.h` |
...
|---|---|
| Include | `vector`, `string`, `map`, `algorithm`, `cstdint`, `iostream`, `memory` |
| Class/Struct | `File`, `FSInfo`, `MockFS` |
| Fungsi C/C++ | `File`, `bool`, `close`, `write`, `read`, `seek`, `position`, `size`, `flush`, `MockFS`, `begin`, `end`, `format`, `exists`, `open`, `remove`, `rename`, `corruptByte`, `dump`, `info`, `LittleFS` |
