---
title: "node/test/mocks/NativeTestHelper.h"
---

# node/test/mocks/NativeTestHelper.h
...
| Item | Nilai |
|---|---|
| Source file | `node/test/mocks/NativeTestHelper.h` |
...
|---|---|
| Include | `Arduino.h`, `LittleFS.h`, `FS.h`, `iostream`, `vector`, `bearssl/bearssl_hash.h`, `support/CryptoUtils.h`, `support/Utils.h`, `utils.cpp`, `system/Logger.cpp`, `system/ConfigManager.cpp`, `net/WifiCredentialStore.cpp` |
| Class/Struct | `EspClass` |
| Fungsi C/C++ | `getChipId`, `getFreeHeap`, `getMaxFreeBlockSize`, `getHeapFragmentation`, `wdtFeed`, `wdtDisable`, `wdtEnable`, `passthrough_encrypt`, `fast_serialize_encrypted`, `fast_serialize_encrypted_main`, `fast_serialize_encrypted_ws`, `releaseWsCipher` |
| Macro | `ESP_MOCK_DEFINED`, `NATIVE_MOCK_TIMEZONE` |
| String command/konfigurasi | `inline`, `extern` |
