---
title: "node/test/mocks/bearssl/bearssl_hmac.h"
---

# node/test/mocks/bearssl/bearssl_hmac.h
...
| Item | Nilai |
|---|---|
| Source file | `node/test/mocks/bearssl/bearssl_hmac.h` |
...
| Class/Struct | `br_hmac_key_context`, `br_hmac_context` |
| Fungsi C/C++ | `br_hmac_key_init`, `br_hmac_init`, `br_hmac_update`, `br_hmac_out` |
