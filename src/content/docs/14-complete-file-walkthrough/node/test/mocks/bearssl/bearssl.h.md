---
title: "node/test/mocks/bearssl/bearssl.h"
---

# node/test/mocks/bearssl/bearssl.h
...
| Item | Nilai |
|---|---|
| Source file | `node/test/mocks/bearssl/bearssl.h` |
...
|---|---|
| Include | `cstddef`, `cstdint` |
| Class/Struct | `br_aes_ct_cbcenc_keys`, `br_aes_ct_cbcdec_keys` |
| Fungsi C/C++ | `br_aes_ct_cbcenc_init`, `br_aes_ct_cbcdec_init`, `br_aes_ct_cbcenc_run`, `br_aes_ct_cbcdec_run` |
