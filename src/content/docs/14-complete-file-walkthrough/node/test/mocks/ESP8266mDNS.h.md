---
title: "node/test/mocks/ESP8266mDNS.h"
---

# node/test/mocks/ESP8266mDNS.h
...
| Item | Nilai |
|---|---|
| Source file | `node/test/mocks/ESP8266mDNS.h` |
...
|---|---|
| Class/Struct | `MDNSResponder` |
| Fungsi C/C++ | `begin`, `update`, `addService`, `close` |
