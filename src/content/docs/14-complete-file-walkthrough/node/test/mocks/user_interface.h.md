---
title: "node/test/mocks/user_interface.h"
---

# node/test/mocks/user_interface.h
...
| Item | Nilai |
|---|---|
| Source file | `node/test/mocks/user_interface.h` |
...
|---|---|
| Fungsi C/C++ | `system_get_free_heap_size` |
