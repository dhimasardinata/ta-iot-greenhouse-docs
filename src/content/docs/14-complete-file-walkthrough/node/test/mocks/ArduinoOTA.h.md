---
title: "node/test/mocks/ArduinoOTA.h"
---

# node/test/mocks/ArduinoOTA.h
...
| Item | Nilai |
|---|---|
| Source file | `node/test/mocks/ArduinoOTA.h` |
...
|---|---|
| Class/Struct | `ArduinoOTAClass` |
| Fungsi C/C++ | `setHostname`, `begin`, `end`, `handle` |
