---
title: "node/test/mocks/ESPAsyncWebServer.h"
---

# node/test/mocks/ESPAsyncWebServer.h
...
| Item | Nilai |
|---|---|
| Source file | `node/test/mocks/ESPAsyncWebServer.h` |
...
|---|---|
| Include | `Arduino.h`, `string`, `sstream`, `functional` |
| Class/Struct | `AwsFrameInfo`, `AsyncWebSocketClient`, `AsyncWebSocket`, `AsyncResponseStream`, `AsyncWebServerRequest` |
| Enum | `AwsEventType` |
| Fungsi C/C++ | `canSend`, `queueLen`, `text`, `close`, `id`, `AsyncWebSocket`, `client`, `onEvent`, `setContentType`, `beginResponseStream`, `send` |
