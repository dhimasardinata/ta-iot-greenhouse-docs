---
title: "node/test/test_integration/mock_sensor_manager.h"
---

# node/test/test_integration/mock_sensor_manager.h
...
| Item | Nilai |
|---|---|
| Source file | `node/test/test_integration/mock_sensor_manager.h` |
...
| Class/Struct | `MockSensorManager` |
| Macro | `MOCK_SENSOR_MANAGER_H` |
