---
title: "node/scripts/check_coding_standard.py"
---

# node/scripts/check_coding_standard.py
...
| Item | Nilai |
|---|---|
| Source file | `node/scripts/check_coding_standard.py` |
| Komponen | Script |
