---
title: "node/scripts/analyze_stack.py"
---

# node/scripts/analyze_stack.py
...
| Item | Nilai |
|---|---|
| Source file | `node/scripts/analyze_stack.py` |
| Komponen | Script |
...
| Fungsi Python | `analyze_stack_usage`, `run_stack_analysis` |
| String command/konfigurasi | `build`, `def`, `size`, `type`, `file`, `wemosd1mini_usb`, `env` |
