---
title: "node/scripts/extra_script.py"
---

# node/scripts/extra_script.py
...
| Item | Nilai |
|---|---|
| Source file | `node/scripts/extra_script.py` |
| Komponen | Script |
...
|---|---|
| Import | `sys`, `pathlib import Path` |
| Fungsi Python | `build_all_nodes_target` |
| String command/konfigurasi | `env`, `scripts`, `build_all_nodes` |
