---
title: "node/scripts/convert_sysincludes.py"
---

# node/scripts/convert_sysincludes.py
...
| Item | Nilai |
|---|---|
| Source file | `node/scripts/convert_sysincludes.py` |
| Komponen | Script |
...
| String command/konfigurasi | `env`, `projenv`, `framework-arduinoespressif8266`, `system`, `user` |
