---
title: "node/scripts/format_all.py"
---

# node/scripts/format_all.py
...
| Item | Nilai |
|---|---|
| Source file | `node/scripts/format_all.py` |
| Komponen | Script |
...
|---|---|
| Import | `os`, `subprocess`, `sys`, `SCons.Script import DefaultEnvironment` |
| Fungsi Python | `format_file_smart`, `collect_files`, `main` |
| String command/konfigurasi | `src`, `include`, `lib`, `test`, `utf-8`, `clang-format`, `clean` |
