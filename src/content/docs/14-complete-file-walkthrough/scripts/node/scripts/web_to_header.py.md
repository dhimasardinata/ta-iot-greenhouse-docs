---
title: "node/scripts/web_to_header.py"
---

# node/scripts/web_to_header.py
...
| Item | Nilai |
|---|---|
| Source file | `node/scripts/web_to_header.py` |
| Komponen | Script |
...
|---|---|
| Import | `os`, `re`, `gzip`, `SCons.Script import DefaultEnvironment` |
| Fungsi Python | `make_valid_varname`, `process_file` |
| String command/konfigurasi | `data`, `include`, `generated`, `utf-8`, `true`, `false` |
