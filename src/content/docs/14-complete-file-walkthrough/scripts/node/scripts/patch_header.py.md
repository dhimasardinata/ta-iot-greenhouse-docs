---
title: "node/scripts/patch_header.py"
---

# node/scripts/patch_header.py
...
| Item | Nilai |
|---|---|
| Source file | `node/scripts/patch_header.py` |
| Komponen | Script |
...
|---|---|
| Import | `os`, `gzip`, `re` |
| Fungsi Python | `generate_cpp_array`, `main` |
| String command/konfigurasi | `data`, `include`, `generated`, `utf-8` |
