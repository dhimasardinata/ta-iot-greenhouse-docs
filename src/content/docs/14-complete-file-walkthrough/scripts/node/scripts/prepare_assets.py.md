---
title: "node/scripts/prepare_assets.py"
---

# node/scripts/prepare_assets.py
...
| Item | Nilai |
|---|---|
| Source file | `node/scripts/prepare_assets.py` |
| Komponen | Script |
...
|---|---|
| Import | `os`, `shutil`, `SCons.Script import DefaultEnvironment` |
| String command/konfigurasi | `node_modules`, `data`, `crypto-js` |
