---
title: "node/scripts/install_watchers_service.sh"
---

# node/scripts/install_watchers_service.sh
...
| Item | Nilai |
|---|---|
| Source file | `node/scripts/install_watchers_service.sh` |
| Komponen | Script |
