---
title: "node/scripts/collect_prompt_files.py"
---

# node/scripts/collect_prompt_files.py
...
| Item | Nilai |
|---|---|
| Source file | `node/scripts/collect_prompt_files.py` |
| Komponen | Script |
...
|---|---|
| Import | `os`, `shutil` |
| Fungsi Python | `is_allowed`, `collect_files` |
| String command/konfigurasi | `tools`, `prompt`, `node_modules`, `var` |
